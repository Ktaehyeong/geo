...
사전에 등록된 질문을 ChatGPT 등 생성형 AI에 입력한 뒤, AI의 답변과 Citation URL을 수집하여 출처 도메인·브랜드·유형별 인용 현황을 확인할 수 있습니다. 수집된 결과는 질문별로 누적됩니다.  최종 데이터는 Excel 형태로 다운로드하여 AI 답변에서 어떤 브랜드와 정보 출처가 주로 인용되는지 분석하는 데 활용할 수 있습니다. 이를 통해 AI가 빈도 높게 인용하는 페이지의 유사성을 기준으로 우리의 콘텐츠를 제작하는 것을 주요 목적으로 합니다.
